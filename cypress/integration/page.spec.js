describe('MoviesList', () => {
  ...
  it('has correct 2nd movie', () => {
    ...
    cy.byDataCy('MovieLink')
      .eq(1)
      .should('have.attr', 'href', 'https://www.imdb.com/title/tt0314331');
  });

  it('has correct 3rd movie', () => {
    cy.byDataCy('MovieTitle')
      .eq(2)
      .should('have.text', 'The Day After Tomorrow');
    cy.byDataCy('MovieLink')
      .eq(2)
      .should('have.attr', 'href', 'https://www.imdb.com/title/tt0319262');
  });
  ...
  it('has correct 5th movie', () => {
    ...
    cy.byDataCy('MovieLink')
      .eq(4)
      .should('have.attr', 'href', 'https://www.imdb.com/title/tt0457939');
  });
});
